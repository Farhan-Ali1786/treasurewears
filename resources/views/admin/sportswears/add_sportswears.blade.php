...
<div class="col-sm-12 col-xl-6 mx-auto my-5">
    <div class="bg-secondary rounded h-100 p-4">
       <div class="d-flex justify-content-between"> <h6 class="mb-4">Add</h6> <a class="btn btn-primary" href="{{route('admin.sports.wears')}}">Show Data</a></div>
       @if (session()->has('msg'))
   ...
   @endif
    <form action="{{route('store.sports.wears')}}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
